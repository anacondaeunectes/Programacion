...
public class Cafetera {
	...
	public void agregarCafe(int cantidadAñadida) {
		if (cantidadAñadida+this.capacidadActual>this.capacidadMaxima) {
			this.capacidadActual=this.capacidadMaxima;
		}else {
			this.capacidadActual=this.capacidadActual+cantidadAñadida;
		}
	}
}
